import svgPaths from "./svg-7crlwa66fg";
...
function DataCard() {
  return (
    <div className="absolute left-0 size-[0.01px] top-0" data-name="Data card">
      ...
      <div className="absolute h-[291px] left-[1404px] top-[872px] w-[185px]" data-name="pencil">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-contain pointer-events-none size-full" src={imgPencil} />
      </div>
      <Age />
      <Name />
      <div className="absolute left-[791px] size-[138px] top-[985px]" data-name="image 7">
...
function Component1() {
  return (
    <div className="absolute left-0 size-[0.01px] top-0" data-name="2">
...
function Component() {
  return (
    <div className="absolute left-0 size-[0.01px] top-0" data-name="1">
...
function Header() {
  return (
    <div className="absolute left-0 size-[0.01px] top-0" data-name="Header">
      <Component1 />
      <Component />
      <div className="absolute h-[151.5px] left-[449px] top-[131.99px] w-[872px]" data-name="image 6">
...
export default function Component2() {
  return (
    <div className="bg-white relative size-full" data-name="2">
      <div className="absolute h-[2480px] left-0 top-0 w-[1754px] z-0" data-name="illustration-happy-childhood-two-children-open-area-festive-atmosphere-balloons-vector">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="Background" className="absolute h-[286.09%] left-[-41.51%] max-w-none top-[-59.23%] w-[269.67%]" src={imgIllustrationHappyChildhoodTwoChildrenOpenAreaFestiveAtmosphereBalloonsVector} />
        </div>
      </div>
      <div className="absolute h-[137px] left-[177px] top-[2196px] w-[1415px] z-10" data-name="image 9">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[1706.67%] left-[-10.75%] max-w-none top-[-1605.17%] w-[110.75%]" src={imgImage9} />
        </div>
      </div>
      <div className="absolute h-[725px] left-[115px] top-[1453px] w-[1539px] z-10" data-name="image 8">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div className="relative z-20">
        ...
        <Header />
        <Pagination />
        <div className="absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[74px] justify-end leading-[0] left-[422px] not-italic text-[60px] text-black top-[1204px] translate-y-[-100%] w-[1128px]">
          <p className="leading-[normal]">Kevin Alozie</p>
        </div>
        <div className="absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[74px] justify-end leading-[0] left-[422px] not-italic text-[60px] text-black top-[1364px] translate-y-[-100%] w-[1128px]">
          <p className="leading-[normal]">12 years</p>
        </div>
      </div>
    </div>
  );

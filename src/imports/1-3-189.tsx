...
import svgPaths from "./svg-yhb7bmvywp";
...
function Subjects() {
  return (
    <div className="absolute h-[2204px] left-[151px] top-[207px] w-[1474px] z-10" data-name="Subjects">
      ...
      <Subject />
      <motion.div 
        className="absolute h-[1610px] left-[728px] top-[485px] w-[469px]" 
        data-name="image 1"
        ...
        transition={{
          ...
          y: { duration: 5.5, repeat: Infinity, ease: "easeInOut", delay: 1.9 }
        }}
      >
...
function Bottom() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[10px] items-end left-[999.42px] px-0 py-px top-[2129.28px] w-[602.06px] z-20 animate-[bounce-subtle_4s_ease-in-out_infinite]" data-name="Bottom" style={{ animationDelay: '1s' }}>
      <Frame2 />
...
function Side() {
  return (
    <div className="absolute h-[471px] left-0 top-[1682px] w-[879px] z-20 animate-[shimmer_3.5s_ease-in-out_infinite]" data-name="Side" style={{ animationDelay: '0.5s' }}>
...
function HealingToTheNations() {
  return (
    <div className="absolute h-[366px] left-[0.15px] top-[39.49px] w-[885px]" data-name="Healing to the Nations">
      <div className="absolute inset-[-10.55%_-4.61%_-11.73%_-4.58%] animate-[float-gentle_4s_ease-in-out_infinite]">
...
function Logo() {
  return (
    <div className="absolute h-[228.783px] left-0 top-0 w-[232.796px] animate-[pulse-glow_3s_ease-in-out_infinite]" data-name="Logo">

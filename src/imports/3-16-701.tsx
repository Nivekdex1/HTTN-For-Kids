import svgPaths from "./svg-gqw48f9s70";
...
import imgVector from "figma:asset/ac26a9e2c88e5d8066bb0142b09917147b99d160.png";
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="3">
      <div className="absolute h-[2480px] left-0 top-0 w-[1754px] z-0" data-name="Vector">
        <img alt="Background" className="block max-w-none size-full" height="2480" src={imgVector} width="1754" />
      </div>
      <div className="absolute h-[984px] left-[143px] top-[1154px] w-[1483px] z-10" data-name="image 11">

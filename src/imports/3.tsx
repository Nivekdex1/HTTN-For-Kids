import svgPaths from "./svg-fvng7uvn9x";
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="3">
      <div className="absolute h-[2480px] left-0 top-0 w-[1754px]" data-name="Vector">
        <img alt="" className="block max-w-none size-full" height="2480" src={imgVector} width="1754" />
      </div>
